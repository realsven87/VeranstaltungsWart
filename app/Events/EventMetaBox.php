...
class EventMetaBox {
    ...
    public function register() {
        ...
        add_meta_box(
            ...
            'Angemeldete Teilnehmer & Warteliste', 
    ...
    public function render_settings_meta_box($post) {
        ...
        <div class="vw-event-settings-fields">
            <p>
                <label for="vw_event_date"><strong>Datum & Uhrzeit:</strong></label>
            ...
            <p>
                <label for="vw_location_id"><strong>Veranstaltungsort:</strong></label>
            ...
            <p>
                <label for="vw_max_capacity"><strong>Max. Teilnehmer:</strong></label>
                <input type="number" name="vw_max_capacity" id="vw_max_capacity" 
                       value="<?php echo esc_attr($current_capacity); ?>" 
                       class="widefat" min="0">
                <span class="description" style="display: block; margin-top: 4px;">0 = Unbegrenzt</span>
            </p>
            ...
            <p>
                <label>
                    ...
                    <strong>Begleitpersonen erlauben</strong>
                </label>
            </p>
        </div>
    ...
    public function render_registration_list($post) {
        ...
        echo '<a href="' . wp_nonce_url(admin_url('admin-post.php?action=vw_export_participants&event_id=' . $post->ID), 'vw_export_nonce') . '" 
                 class="button button-secondary">
                 <span class="dashicons dashicons-download" style="margin-top:4px;"></span> Teilnehmerliste (CSV) exportieren
              </a>';
        echo '</div>';
        ...
        if (file_exists($view_file)) {
            ...
            echo '<p>Teilnehmerliste konnte nicht geladen werden.</p>';
        }
    }
}